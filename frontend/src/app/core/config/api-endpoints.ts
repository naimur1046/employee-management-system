...
export const API_ENDPOINTS = {
  ...
  DEPARTMENTS: {
    BASE: `${API_BASE}/department`,
    BY_ID: (id: string) => `${API_BASE}/department/${id}`,
    WITH_EMPLOYEES: (id: string) => `${API_BASE}/department/${id}/employees`,
    SEARCH: `${API_BASE}/department/search`
  },
